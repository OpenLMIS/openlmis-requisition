...
* [OLMIS-2871](https://openlmis.atlassian.net/browse/OLMIS-2871): The service now uses the Authorization header instead of an access_token request parameter when communicating with other services.
